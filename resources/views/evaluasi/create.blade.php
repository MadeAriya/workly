                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('manage_evaluasi.store') }}"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select name="users_id" id="user_id" class="form-control select2bs4">
                                                @foreach ($user as $users)
                                                    <option value="{{ $users->id }}" {{ request('users_id') == $users->id ? 'selected' : '' }}>{{ $users->username }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="evaluasi_admin">Evaluasi Admin</label>
                                            <textarea id="summernote" name="evaluasi_admin">
                                                Place <em>some</em> <u>text</u> <strong>here</strong>
                                            </textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="catatan">Catatan</label>
                                            <textarea id="summernote2" name="catatan">
                                                Place <em>some</em> <u>text</u> <strong>here</strong>
                                            </textarea>
                                        </div>
                                    </div>
