                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form method="post" action="{{ route('manage_payrolls.store') }}"
                                    enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nama Karyawan</label>
                                            <select name="users_id" id="user_id" class="form-control select2bs4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                                <input type="text" name="bulan" class="form-control datetimepicker-input" data-target="#reservationdate"/>
                                        ...
                                        <div class="form-group">
                                            <label for="evaluasi_admin">Gaji Pokok</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Rp.</span>
                                                </div>
                                                <input type="number" name="gaji_pokok" value="{{ request('gaji_pokok') }}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="evaluasi_admin">Tunjangan</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Rp.</span>
                                                </div>
                                                <input type="number" name="tunjangan" value="{{ request('tunjangan') }}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="evaluasi_admin">Bonus</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Rp.</span>
                                                </div>
                                                <input type="number" name="bonus" value="{{ request('bonus') }}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="evaluasi_admin">BPJS</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Rp.</span>
                                                </div>
                                                <input type="number" name="bpjs" value="{{ request('bpjs') }}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="evaluasi_admin">Pajak</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Rp.</span>
                                                </div>
                                                <input type="number" name="pajak" value="{{ request('pajak') }}" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
