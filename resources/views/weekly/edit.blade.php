                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Weekly Plan</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <div class="card-body">
                                    <form method="post" action="{{ route('manage_weekly.update', $weekly->id) }}" id="form">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="reservationdate"
                                                ...
                                                <input type="text" class="form-control datetimepicker-input"
                                                    ...
                                                    id="tanggalMulai" value="{{ $weekly->tanggalMulai }}"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="endDate" data-target-input="nearest">
                                                <input type="text" class="form-control datetimepicker-input"
                                                data-target="#endDate" name="tanggalSelesai" id="tanggalSelesai" value="{{ $weekly->tanggalSelesai }}"/>
                                    ...
                                    @foreach(json_decode($weekly->target, true) ?? [] as $item)
                                    <div class="wrapper-form">
                                        <div class="form-group">
                                            <input type="text" name="target[]" id="target" value="{{ $item }}" class="form-control">
                                        </div>
                                    </div>
                                    @endforeach
